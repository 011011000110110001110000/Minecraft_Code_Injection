...
/**
 * Basically {@link sun.misc.Unsafe}, but static.
 *
 * @author Lollopollqo
 */
...
public class UnsafeUtils {
    ...
    static {
        try {
            ...
            Class<?> unsafeClass = theUnsafe.getClass();

            MethodHandles.Lookup lookup = MethodHandles.lookup();
            getObjectInt = lookup.findVirtual(unsafeClass, "getInt", MethodType.methodType(int.class, Object.class, long.class)).bindTo(theUnsafe);
            getObjectObject = lookup.findVirtual(unsafeClass, "getObject", MethodType.methodType(Object.class, Object.class, long.class)).bindTo(theUnsafe);
            getObjectBoolean = lookup.findVirtual(unsafeClass, "getBoolean", MethodType.methodType(boolean.class, Object.class, long.class)).bindTo(theUnsafe);
            getObjectByte = lookup.findVirtual(unsafeClass, "getByte", MethodType.methodType(byte.class, Object.class, long.class)).bindTo(theUnsafe);
            getObjectShort = lookup.findVirtual(unsafeClass, "getShort", MethodType.methodType(short.class, Object.class, long.class)).bindTo(theUnsafe);
            getObjectChar = lookup.findVirtual(unsafeClass, "getChar", MethodType.methodType(char.class, Object.class, long.class)).bindTo(theUnsafe);
            getObjectLong = lookup.findVirtual(unsafeClass, "getLong", MethodType.methodType(long.class, Object.class, long.class)).bindTo(theUnsafe);
            getObjectFloat = lookup.findVirtual(unsafeClass, "getFloat", MethodType.methodType(float.class, Object.class, long.class)).bindTo(theUnsafe);
            getObjectDouble = lookup.findVirtual(unsafeClass, "getDouble", MethodType.methodType(double.class, Object.class, long.class)).bindTo(theUnsafe);

            putObjectInt = lookup.findVirtual(unsafeClass, "putInt", MethodType.methodType(void.class, Object.class, long.class, int.class)).bindTo(theUnsafe);
            putObjectObject = lookup.findVirtual(unsafeClass, "putObject", MethodType.methodType(void.class, Object.class, long.class, Object.class)).bindTo(theUnsafe);
            putObjectBoolean = lookup.findVirtual(unsafeClass, "putBoolean", MethodType.methodType(void.class, Object.class, long.class, boolean.class)).bindTo(theUnsafe);
            putObjectByte = lookup.findVirtual(unsafeClass, "putByte", MethodType.methodType(void.class, Object.class, long.class, byte.class)).bindTo(theUnsafe);
            putObjectShort = lookup.findVirtual(unsafeClass, "putShort", MethodType.methodType(void.class, Object.class, long.class, short.class)).bindTo(theUnsafe);
            putObjectChar = lookup.findVirtual(unsafeClass, "putChar", MethodType.methodType(void.class, Object.class, long.class, char.class)).bindTo(theUnsafe);
            putObjectLong = lookup.findVirtual(unsafeClass, "putLong", MethodType.methodType(void.class, Object.class, long.class, long.class)).bindTo(theUnsafe);
            putObjectFloat = lookup.findVirtual(unsafeClass, "putFloat", MethodType.methodType(void.class, Object.class, long.class, float.class)).bindTo(theUnsafe);
            putObjectDouble = lookup.findVirtual(unsafeClass, "putDouble", MethodType.methodType(void.class, Object.class, long.class, double.class)).bindTo(theUnsafe);

            getByte = lookup.findVirtual(unsafeClass, "getByte", MethodType.methodType(byte.class, long.class)).bindTo(theUnsafe);
            getShort = lookup.findVirtual(unsafeClass, "getShort", MethodType.methodType(short.class, long.class)).bindTo(theUnsafe);
            getChar = lookup.findVirtual(unsafeClass, "getChar", MethodType.methodType(char.class, long.class)).bindTo(theUnsafe);
            getInt = lookup.findVirtual(unsafeClass, "getInt", MethodType.methodType(int.class, long.class)).bindTo(theUnsafe);
            getLong = lookup.findVirtual(unsafeClass, "getLong", MethodType.methodType(long.class, long.class)).bindTo(theUnsafe);
            getFloat = lookup.findVirtual(unsafeClass, "getFloat", MethodType.methodType(float.class, long.class)).bindTo(theUnsafe);
            getDouble = lookup.findVirtual(unsafeClass, "getDouble", MethodType.methodType(double.class, long.class)).bindTo(theUnsafe);
            getAddress = lookup.findVirtual(unsafeClass, "getAddress", MethodType.methodType(long.class, long.class)).bindTo(theUnsafe);

            putByte = lookup.findVirtual(unsafeClass, "putByte", MethodType.methodType(void.class, long.class, byte.class)).bindTo(theUnsafe);
            putShort = lookup.findVirtual(unsafeClass, "putShort", MethodType.methodType(void.class, long.class, short.class)).bindTo(theUnsafe);
            putChar = lookup.findVirtual(unsafeClass, "putChar", MethodType.methodType(void.class, long.class, char.class)).bindTo(theUnsafe);
            putInt = lookup.findVirtual(unsafeClass, "putInt", MethodType.methodType(void.class, long.class, int.class)).bindTo(theUnsafe);
            putLong = lookup.findVirtual(unsafeClass, "putLong", MethodType.methodType(void.class, long.class, long.class)).bindTo(theUnsafe);
            putFloat = lookup.findVirtual(unsafeClass, "putFloat", MethodType.methodType(void.class, long.class, float.class)).bindTo(theUnsafe);
            putDouble = lookup.findVirtual(unsafeClass, "putDouble", MethodType.methodType(void.class, long.class, double.class)).bindTo(theUnsafe);
            putAddress = lookup.findVirtual(unsafeClass, "putAddress", MethodType.methodType(void.class, long.class, long.class)).bindTo(theUnsafe);

            allocateMemory = lookup.findVirtual(unsafeClass, "allocateMemory", MethodType.methodType(long.class, long.class)).bindTo(theUnsafe);
            reallocateMemory = lookup.findVirtual(unsafeClass, "reallocateMemory", MethodType.methodType(long.class, long.class, long.class)).bindTo(theUnsafe);
            setObjectMemory = lookup.findVirtual(unsafeClass, "setMemory", MethodType.methodType(void.class, Object.class, long.class, long.class, byte.class)).bindTo(theUnsafe);
            setMemory = lookup.findVirtual(unsafeClass, "setMemory", MethodType.methodType(void.class, long.class, long.class, byte.class)).bindTo(theUnsafe);
            copyObjectMemory = lookup.findVirtual(unsafeClass, "copyMemory", MethodType.methodType(void.class, Object.class, long.class, Object.class, long.class, long.class)).bindTo(theUnsafe);
            copyMemory = lookup.findVirtual(unsafeClass, "copyMemory", MethodType.methodType(void.class, long.class, long.class, long.class)).bindTo(theUnsafe);
            freeMemory = lookup.findVirtual(unsafeClass, "freeMemory", MethodType.methodType(void.class, long.class)).bindTo(theUnsafe);
            objectFieldOffset = lookup.findVirtual(unsafeClass, "objectFieldOffset", MethodType.methodType(long.class, Field.class)).bindTo(theUnsafe);
            staticFieldOffset = lookup.findVirtual(unsafeClass, "staticFieldOffset", MethodType.methodType(long.class, Field.class)).bindTo(theUnsafe);
            staticFieldBase = lookup.findVirtual(unsafeClass, "staticFieldBase", MethodType.methodType(Object.class, Field.class)).bindTo(theUnsafe);
            shouldBeInitialized = lookup.findVirtual(unsafeClass, "shouldBeInitialized", MethodType.methodType(boolean.class, Class.class)).bindTo(theUnsafe);
            ensureClassInitialized = lookup.findVirtual(unsafeClass, "ensureClassInitialized", MethodType.methodType(void.class, Class.class)).bindTo(theUnsafe);
            arrayBaseOffset = lookup.findVirtual(unsafeClass, "arrayBaseOffset", MethodType.methodType(int.class, Class.class)).bindTo(theUnsafe);
            arrayIndexScale = lookup.findVirtual(unsafeClass, "arrayIndexScale", MethodType.methodType(int.class, Class.class)).bindTo(theUnsafe);
            addressSize = lookup.findVirtual(unsafeClass, "addressSize", MethodType.methodType(int.class)).bindTo(theUnsafe);
            pageSize = lookup.findVirtual(unsafeClass, "pageSize", MethodType.methodType(int.class)).bindTo(theUnsafe);
            // Removed in  JDK 17
            // defineAnonymousClass = lookup.findVirtual(unsafeClass, "defineAnonymousClass", MethodType.methodType(Class.class, Class.class, byte[].class, Object[].class)).bindTo(unsafe);
            allocateInstance = lookup.findVirtual(unsafeClass, "allocateInstance", MethodType.methodType(Object.class, Class.class)).bindTo(theUnsafe);
            throwException = lookup.findVirtual(unsafeClass, "throwException", MethodType.methodType(void.class, Throwable.class)).bindTo(theUnsafe);
            compareAndSwapObject = lookup.findVirtual(unsafeClass, "compareAndSwapObject", MethodType.methodType(boolean.class, Object.class, long.class, Object.class, Object.class)).bindTo(theUnsafe);
            compareAndSwapInt = lookup.findVirtual(unsafeClass, "compareAndSwapInt", MethodType.methodType(boolean.class, Object.class, long.class, int.class, int.class)).bindTo(theUnsafe);
            compareAndSwapLong = lookup.findVirtual(unsafeClass, "compareAndSwapLong", MethodType.methodType(boolean.class, Object.class, long.class, long.class, long.class)).bindTo(theUnsafe);

            getObjectVolatile = lookup.findVirtual(unsafeClass, "getObjectVolatile", MethodType.methodType(Object.class, Object.class, long.class)).bindTo(theUnsafe);
            getIntVolatile = lookup.findVirtual(unsafeClass, "getIntVolatile", MethodType.methodType(int.class, Object.class, long.class)).bindTo(theUnsafe);
            getBooleanVolatile = lookup.findVirtual(unsafeClass, "getBooleanVolatile", MethodType.methodType(boolean.class, Object.class, long.class)).bindTo(theUnsafe);
            getByteVolatile = lookup.findVirtual(unsafeClass, "getByteVolatile", MethodType.methodType(byte.class, Object.class, long.class)).bindTo(theUnsafe);
            getShortVolatile = lookup.findVirtual(unsafeClass, "getShortVolatile", MethodType.methodType(short.class, Object.class, long.class)).bindTo(theUnsafe);
            getCharVolatile = lookup.findVirtual(unsafeClass, "getCharVolatile", MethodType.methodType(char.class, Object.class, long.class)).bindTo(theUnsafe);
            getLongVolatile = lookup.findVirtual(unsafeClass, "getLongVolatile", MethodType.methodType(long.class, Object.class, long.class)).bindTo(theUnsafe);
            getFloatVolatile = lookup.findVirtual(unsafeClass, "getFloatVolatile", MethodType.methodType(float.class, Object.class, long.class)).bindTo(theUnsafe);
            getDoubleVolatile = lookup.findVirtual(unsafeClass, "getDoubleVolatile", MethodType.methodType(double.class, Object.class, long.class)).bindTo(theUnsafe);

            putObjectVolatile = lookup.findVirtual(unsafeClass, "putObjectVolatile", MethodType.methodType(void.class, Object.class, long.class, Object.class)).bindTo(theUnsafe);
            putIntVolatile = lookup.findVirtual(unsafeClass, "putIntVolatile", MethodType.methodType(void.class, Object.class, long.class, int.class)).bindTo(theUnsafe);
            putBooleanVolatile = lookup.findVirtual(unsafeClass, "putBooleanVolatile", MethodType.methodType(void.class, Object.class, long.class, boolean.class)).bindTo(theUnsafe);
            putByteVolatile = lookup.findVirtual(unsafeClass, "putByteVolatile", MethodType.methodType(void.class, Object.class, long.class, byte.class)).bindTo(theUnsafe);
            putShortVolatile = lookup.findVirtual(unsafeClass, "putShortVolatile", MethodType.methodType(void.class, Object.class, long.class, short.class)).bindTo(theUnsafe);
            putCharVolatile = lookup.findVirtual(unsafeClass, "putCharVolatile", MethodType.methodType(void.class, Object.class, long.class, char.class)).bindTo(theUnsafe);
            putLongVolatile = lookup.findVirtual(unsafeClass, "putLongVolatile", MethodType.methodType(void.class, Object.class, long.class, long.class)).bindTo(theUnsafe);
            putFloatVolatile = lookup.findVirtual(unsafeClass, "putFloatVolatile", MethodType.methodType(void.class, Object.class, long.class, float.class)).bindTo(theUnsafe);
            putDoubleVolatile = lookup.findVirtual(unsafeClass, "putDoubleVolatile", MethodType.methodType(void.class, Object.class, long.class, double.class)).bindTo(theUnsafe);

            putOrderedObject = lookup.findVirtual(unsafeClass, "putOrderedObject", MethodType.methodType(void.class, Object.class, long.class, Object.class)).bindTo(theUnsafe);
            putOrderedInt = lookup.findVirtual(unsafeClass, "putOrderedInt", MethodType.methodType(void.class, Object.class, long.class, int.class)).bindTo(theUnsafe);
            putOrderedLong = lookup.findVirtual(unsafeClass, "putOrderedLong", MethodType.methodType(void.class, Object.class, long.class, long.class)).bindTo(theUnsafe);

            unpark = lookup.findVirtual(unsafeClass, "unpark", MethodType.methodType(void.class, Object.class)).bindTo(theUnsafe);
            park = lookup.findVirtual(unsafeClass, "park", MethodType.methodType(void.class, boolean.class, long.class)).bindTo(theUnsafe);
            getLoadAverage = lookup.findVirtual(unsafeClass, "getLoadAverage", MethodType.methodType(int.class, double[].class, int.class)).bindTo(theUnsafe);

            getAndAddInt = lookup.findVirtual(unsafeClass, "getAndAddInt", MethodType.methodType(int.class, Object.class, long.class, int.class)).bindTo(theUnsafe);
            getAndAddLong = lookup.findVirtual(unsafeClass, "getAndAddLong", MethodType.methodType(long.class, Object.class, long.class, long.class)).bindTo(theUnsafe);
            getAndSetInt = lookup.findVirtual(unsafeClass, "getAndSetInt", MethodType.methodType(int.class, Object.class, long.class, int.class)).bindTo(theUnsafe);
            getAndSetLong = lookup.findVirtual(unsafeClass, "getAndSetLong", MethodType.methodType(long.class, Object.class, long.class, long.class)).bindTo(theUnsafe);
            getAndSetObject = lookup.findVirtual(unsafeClass, "getAndSetObject", MethodType.methodType(Object.class, Object.class, long.class, Object.class)).bindTo(theUnsafe);

            loadFence = lookup.findVirtual(unsafeClass, "loadFence", MethodType.methodType(void.class)).bindTo(theUnsafe);
            storeFence = lookup.findVirtual(unsafeClass, "storeFence", MethodType.methodType(void.class)).bindTo(theUnsafe);
            fullFence = lookup.findVirtual(unsafeClass, "fullFence", MethodType.methodType(void.class)).bindTo(theUnsafe);

            invokeCleaner = lookup.findVirtual(unsafeClass, "invokeCleaner", MethodType.methodType(void.class, ByteBuffer.class)).bindTo(theUnsafe);
    ...
    private static Unsafe getUnsafe() throws ClassNotFoundException, IllegalAccessException {
        Class<?> unsafeClass = Class.forName("sun.misc.Unsafe");
        Object theUnsafe = null;
        {
            int accessModifiers = Modifier.PRIVATE | Modifier.STATIC | Modifier.FINAL;
            for (Field field : unsafeClass.getDeclaredFields()) {
                if (field.getModifiers() == accessModifiers && field.getType() == unsafeClass) {
        ...
        return (sun.misc.Unsafe) theUnsafe;
    }
